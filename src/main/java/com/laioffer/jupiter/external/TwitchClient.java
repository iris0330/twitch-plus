...
public class TwitchClient {
    private static final String TOKEN = "Bearer 8csdgg65he79q94j9rjja5svdi3dqe";
    private static final String CLIENT_ID = "hsmcvpm0xscokz2jpd1e95mai6273z";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            return String.format(url, limit); // top game url
        }
        else {
            try {
            ...
            return String.format(url, gameName); // search game url
        }
    }
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> {
            ...
            if (responseCode != 200) {
                ...
                throw new TwitchException("Failed to get status ok from Twitch API");
            }
            HttpEntity entity = response.getEntity();
            if (entity == null) {
                throw new TwitchException("Failed to get response body from Twitch API");
            }
